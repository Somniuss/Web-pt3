...
<body>
    ...
    <div class="news-container">
        ...
        <div class="news-item">
            <h3>News Title 1</h3>
            <p>Brief description of the news content goes here.</p>
        </div>
        <div class="news-item">
            <h3>News Title 2</h3>
            <p>Another brief description of the news content goes here.</p>
        </div>
        <div class="news-item">
            <h3>News Title 3</h3>
            <p>More details about this news content.</p>
        </div>
    </div>
</body>
</html>
